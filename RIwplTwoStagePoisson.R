...
estimator_PL<-fit_PL(TwostagePoissonSample$y, TwostagePoissonSampleis$cluster, TwostagePoissonSampleis$x, pars=c(0,0,1,1))
estimator_PL

###informative sampling (without weight)
estimatoris_PL<- fit_PL(TwostagePoissonSampleis$y, TwostagePoissonSampleis$cluster, TwostagePoissonSampleis$x, pars=c(0,0,1,1))
estimatoris_PL
...
fit_WPL<-function(y,g,x, pos, sc,fss,  n2infor, N2,  pars){
   ...
   gr<-function(theta){
      wincrementda=wdalpha(y[i],y[j],g[i],g[j],x[i],x[j], alpha=theta[1],beta=theta[2],
                           sigma2=exp(theta[3]),tau2=exp(theta[4]),pos[i], pos[j], sc[i], sc[j], 
                           fss, n2infor,N2)
      ...
      wincrementds=exp(theta[3])*wdsigma2(y[i],y[j],g[i],g[j],x[i],x[j],
                                          alpha=theta[1],beta=theta[2],sigma2=exp(theta[3]),tau2=exp(theta[4]), pos[i], pos[j], sc[i], sc[j], 
                                          fss, n2infor,N2)
...
pairscore_PL(TwostagePoissonSample$y, TwostagePoissonSample$cluster, TwostagePoissonSample$x,estimator_PL[[1]])
##informative sampling (without weight)
pairscore_PL(TwostagePoissonSampleis$y, TwostagePoissonSampleis$cluster,TwostagePoissonSampleis$x,estimatoris_PL[[1]])
...
##uninformative sampling WPL (with weight)
pairscore_WPL(TwostagePoissonSample$y, TwostagePoissonSample$cluster, TwostagePoissonSample$x,
              theta=estimator_WPL[[1]],  TwostagePoissonSample$ID_unit, TwostagePoissonSample$PSU, fss=pi1, n2infor=FirststagePoisson*n2, N2)
##informative sampling WPL (with weight)
pairscore_WPL(TwostagePoissonSampleis$y, TwostagePoissonSampleis$cluster,TwostagePoissonSampleis$x,
   ...
   for (i in 1:(n-1)){
      ...
      for(j in js){
         ...
         incrementdaij=wdalpha(y[i],y[j],g[i],g[j],x[i],x[j], alpha=theta[1],beta=theta[2],sigma2=exp(theta[3]),
                               tau2=exp(theta[4]), pos[i], pos[j],sc[i], sc[j], fss, n2infor,N2)
         ...
         incrementdakl=wdalpha(y[k],y[l],g[k],g[l],x[k],x[l], alpha=theta[1],beta=theta[2],
                               sigma2=exp(theta[3]),tau2=exp(theta[4]), pos[k], pos[l], sc[k], sc[l], fss, n2infor,N2)
...
for(i in 1:LOTS){
   ...
   rb<-fit_PL(TwostagePoissonSample$y, TwostagePoissonSampleis$cluster, TwostagePoissonSampleis$x, pars=c(0,0,1,1))
   ...
   rbis<-fit_PL(TwostagePoissonSampleis$y, TwostagePoissonSampleis$cluster, TwostagePoissonSampleis$x, pars=c(0,0,1,1))
